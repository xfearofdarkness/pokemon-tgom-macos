################################################################################
# PSystem_Utilities — Essentials 18 original + Ruby 3 JSON regex fix for mkxp-z
# (Replaces the old mega-dummy that clobbered ItemStorageHelper / PE17 APIs)
# Kawariki match: pbNextComb
################################################################################
#===============================================================================
